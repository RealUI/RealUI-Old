...
L["Class icons"] = "職業圖示" -- Needs review
L["Click for"] = "點擊後為"
L["Clickthrough"] = "點擊到底"
L["Columns"] = "計量條上"
L["Combat mode"] = "戰鬥模組"
...
L["The height of the title frame."] = "標題框架的高度" -- Needs review
...
L["Title bar"] = "標題條"
L["Title height"] = "標題高度" -- Needs review
...
L["TPS"] = "每秒威脅值"
L["Use class icons where applicable."] = "使用職業圖示(如果適用)." -- Needs review
