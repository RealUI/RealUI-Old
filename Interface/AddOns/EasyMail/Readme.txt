...
Configuration
-------------
Slash commands have been disabled. Use the new interface options window to configure EasyMail. Open the main menu, click Interface, click the AddOns tab, and select the EasyMail entry.
