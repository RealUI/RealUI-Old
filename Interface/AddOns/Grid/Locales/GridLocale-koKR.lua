...
L["Color the healing bar using the active status color instead of the health bar color."] = "생명력 바 색상 대신 활성 상태의 색상을 사용하여 치료 바 색상을 표시합니다." -- Needs review
...
L["Healing Bar Uses Status Color"] = "치유 바 상태 색상 사용" -- Needs review
L["Health Bar"] = "생명력 바"
...
L["Show status only if the unit is in range."] = "유닛이 거리에 있을때 상태에 표시합니다." -- Needs review
L["Status"] = "상태"
L["Status: %s"] = "상태: %s"
L["Text"] = "문자"
...
L["(De)buff name"] = "(디)버프 이름" -- Needs review
L["Debuff: %s"] = "디버프: %s"
...
L["Show on %s players."] = "%s 플레이어를 표시합니다." -- Needs review
