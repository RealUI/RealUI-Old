...
L["All Edge resizing"] = "Veränderbare Größe an allen Ecken" -- Needs review
...
L["Enables the Tab to flash when you miss a message"] = "Aktiviert blinkende Registerkarten wenn du eine Nachricht verpasst." -- Needs review
...
L["Enable Tab Flashing"] = "Aktiviere blinkende Registerkarten" -- Needs review
...
L["(|HBNplayer.-|h): whispers:"] = "(|HBNplayer.-|h): flüstert:" -- Needs review
...
L["(|Hplayer.-|h) whispers:"] = "(|Hplayer.-|h) flüstert:" -- Needs review
L["Hunter"] = "Jäger"
...
L["Mage"] = "Magier"
L["Makes channels you select sticky."] = "Macht Kanäle die du auswählst beständig." -- Needs review
...
L["Make %s sticky"] = "Macht %s beständig" -- Needs review
...
L["None"] = "Nichts"
L["No RealNames"] = "Keine echten Namen" -- Needs review
L["Officer"] = "Offizier"
...
L["RealID Brackets"] = "RealID Klammern" -- Needs review
...
L["Show toon names instead of real names"] = "Zeigt Namen der Charakter statt der der Spieler." -- Needs review
...
L["Sticky Channels"] = "Beständige Kanäle" -- Needs review
L["Strip RealID brackets"] = "RealID Klammern ausblenden" -- Needs review
...
L["To <Away>(|HBNplayer.-|h):"] = "An <Abwesend>(|HBNplayer.-|h):" -- Needs review
L["To <Busy>(|HBNplayer.-|h):"] = "An <Beschäftigt>(|HBNplayer.-|h):" -- Needs review
L["Toggle the copy icon on the chat frame."] = "Schaltet das Kopiericon im Chatfenster ein oder aus" -- Needs review
L["^To (.-|h):"] = "an (.-|h):"
