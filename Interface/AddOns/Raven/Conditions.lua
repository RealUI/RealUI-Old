...
local function CheckTestAND(ttype, t)
	...
	if ttype == "Player Status" then
		...
		if IsOn(t.checkRunes) then
			if not MOD:IsRuneSpellReady(t.needBlood, t.needFrost, t.needUnholy, t.checkAnyRune) then return false end
...
local function CheckTestOR(ttype, t)
	...
	if ttype == "Player Status" then
		...
		if IsOn(t.checkRunes) then
			if MOD:IsRuneSpellReady(t.needBlood, t.needFrost, t.needUnholy, t.checkAnyRune) then return true end
