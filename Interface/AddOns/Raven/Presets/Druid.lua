...
Raven.classSpells.DRUID = {
	...
	{ "Bear Hug", DEBUFF, p.Red2, cooldown = true, school = "Physical", id = 102795 },
	{ "Berserk", BUFF, p.Orange3, cooldown = true, school = "Physical", id = 106952 },
	{ "Cat Form", BUFF, p.Cyan, school = "Physical", id = 768 },
	{ "Celestial Alignment", BUFF, p.Blue3, cooldown = true, school = "Physical", id = 112071 },
	{ "Cenarion Ward", BUFF, p.Green3, cooldown = true, school = "Nature", id = 102351 },
	{ "Charm Woodland Creature", BUFF, p.Pink, school = "Physical", id = 127757 },
	...
	{ "Disorienting Roar", DEBUFF, p.Brown3, cooldown = true, school = "Physical", id = 99 },
	{ "Displacer Beast", BUFF, p.Blue2, cooldown = true, school = "Physical", id = 102280 },
	...
	{ "Fungal Growth", DEBUFF, p.Blue3, school = "Physical", id = 81283 },
	...
	{ "Incarnation", BUFF, p.Cyan, cooldown = true, school = "Physical", id = 106731 },
	{ "Incarnation: Chosen of Elune", BUFF, p.Cyan, school = "Physical", id = 102560 },
	{ "Incarnation: King of the Jungle", BUFF, p.Cyan, school = "Physical", id = 102543 },
	{ "Incarnation: Son of Ursoc", BUFF, p.Cyan, school = "Physical", id = 102558 },
	{ "Incarnation: Tree of Life", BUFF, p.Cyan, school = "Physical", id = 33891 },
	{ "Infected Wounds", DEBUFF, p.Red3, school = "Physical", id = 48484 },
	{ "Innervate", BUFF, p.Blue1, cooldown = true, school = "Nature", id = 29166 },
	{ "Ironbark", BUFF, p.Brown2, cooldown = true, school = "Nature", id = 102342 },
	{ "Lacerate", DEBUFF, p.Purple3, cooldown = true, school = "Physical", id = 33745 },
	...
	{ "Lunar Shower", BUFF, p.Cyan, school = "Physical", id = 33605 },
	{ "Maim", DEBUFF, p.Brown2, cooldown = true, school = "Physical", id = 22570 },
	{ "Mangle", DEBUFF, p.Red3, cooldown = true, school = "Physical", id = 33917 },
	...
	{ "Mastery: Harmony", BUFF, p.Yellow1, school = "Physical", id = 77495 },
	{ "Mastery: Nature's Guardian", BUFF, p.Cyan, school = "Physical", id = 77494 },
	{ "Mastery: Razor Claws", BUFF, p.Brown3, school = "Physical", id = 77493 },
	{ "Mastery: Total Eclipse", BUFF, p.Blue2, school = "Physical", id = 77492 },
	{ "Maul", nil, p.Brown2, cooldown = true, school = "Physical", id = 6807 },
	{ "Might of Ursoc", BUFF, p.Green1, cooldown = true, school = "Physical", id = 106922 },
	{ "Mighty Bash", DEBUFF, p.Cyan, cooldown = true, school = "Physical", id = 5211 },
	...
	{ "Nature's Cure", nil, p.Grey, cooldown = true, school = "Physical", id = 88423 },
	{ "Nature's Grace", BUFF, p.Brown1, id = 16886 },
	{ "Nature's Grasp", BUFF, p.Brown3, cooldown = true, school = "Nature", id = 16689 },
	{ "Nature's Swiftness", BUFF, p.Blue3, cooldown = true, school = "Physical", id = 132158 },
	...
	{ "Predatory Swiftness", BUFF, p.Yellow3, school = "Physical", id = 16974 },
	...
	{ "Savage Defense", BUFF, p.Orange2, cooldown = true, school = "Physical", id = 62606 },
	{ "Savage Roar", BUFF, p.Green3, school = "Physical", id = 52610 },
	{ "Shooting Stars", BUFF, p.Blue2, school = "Physical", id = 93399 },
	{ "Shred", nil, p.Yellow2, school = "Physical", id = 5221 },
	{ "Skull Bash", DEBUFF, p.Gray, cooldown = true, school = "Physical", id = 106839 },
	...
	{ "Stampeding Roar", BUFF, p.Orange1, cooldown = true, school = "Physical", id = 106898 },
	...
	{ "Wild Charge", nil, p.Purple3, cooldown = true, school = "Physical", id = 102401 },
