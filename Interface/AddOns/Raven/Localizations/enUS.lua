...
L["Spell Name"] = true
L["Enter spell name (or numeric identifier) whose color you want to change."] = true
...
L["Reset"] = true
L["Reset color and label string"] = function(s) return string.format("Reset color, label and sound for %s back to default.", s) end
L["Reset color and label confirm"] = function(s) return string.format("RESET SPELL\nAre you sure you want to reset the color, label and sound for %s back to default?", s) end
L["Reset Spell Colors"] = true
...
L['Include magic buffs (these can usually be removed with abilities like Purge).'] = true
...
L["Delay"] = true
L["Set number of seconds before bar will hide or fade."] = true
